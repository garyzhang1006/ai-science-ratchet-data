...
def check_bindings():
    ...
    binds = [
        ...
        ("p-values drops $0.055$ per generation", h1("neutral", "numeric_share_exact"), -0.055),
        ("p-values falls $0.055$ per generation", h1("neutral", "numeric_share_exact"), -0.055),
        ...
        ("Numeric fidelity falls from $1.00$", pn["trajectories_neutral"]["numeric_g0"], 1.00),
        ("falls from $1.00$ to $0.56$ between the source", pn["trajectories_neutral"]["numeric_g1"], 0.56),
        ("falls only from $0.56$ to $0.45$", pn["trajectories_neutral"]["numeric_g10"], 0.45),
        ("pooled numeric fidelity drops from $1.00$ to $0.45$", pn["trajectories_neutral"]["numeric_g10"], 0.45),
        ...
        ("Numeric loss falls by $81.1\\%$", res["H3_regime"]["numeric_share_exact"]["reduction_share"], 0.811),
        ...
        ("numeric fidelity of $0.90$ is retained", pn["trajectories_conservative"]["numeric_g10"], 0.90),
        ("against $0.45$ under neutral", pn["trajectories_neutral"]["numeric_g10"], 0.45),
        ("numeric fidelity $-0.0610$ against", sens_est("numeric_share_exact"), -0.061),
        ("$-0.0610$ against $-0.0483$", pn["greedy_drift_on_sensitivity_subset"]["numeric_share_exact"]["estimate"], -0.0483),
        ("moves numeric fidelity from $0.49$", pn["trajectories_neutral"]["numeric_g4"], 0.49),
        ("from $0.49$ to $0.52$", pn["trajectories_neutral"]["numeric_g2"], 0.52),
